...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'switch_init'
;------------------------------------------------------------
;	switch.c:17: void switch_init(void) {
;	-----------------------------------------
...
_switch_init:
	...
	ar1 = 0x01
	ar0 = 0x00
;	switch.c:19: gpioConfigure(&switch_gpio);
	mov	dptr,#_switch_gpio
	mov	b,#0x00
;	switch.c:21: }
	ljmp	_gpioConfigure
;------------------------------------------------------------
;Allocation info for local variables in function 'get_switch_status'
;------------------------------------------------------------
;	switch.c:23: switch_status_t get_switch_status(void) { return UINT8_TO_SWITCH_STATUS[gpioRead(&switch_gpio)]; }
;	-----------------------------------------
...
_get_switch_status:
	...
	lcall	_gpioRead
	mov	a,dpl
	mov	dptr,#_UINT8_TO_SWITCH_STATUS
	movc	a,@a+dptr
	mov	dpl,a
	ret
	.area CSEG    (CODE)
...
_FONTS:
	...
	.db #0x00	; 0
	.db #0x00	; 0
_UINT8_TO_SWITCH_STATUS:
	.db #0x00	; 0
	.db #0x01	; 1
	.area XINIT   (CODE)
__xinit__switch_gpio:
	.db #0x03	; 3
	.db #0x07	; 7
	.db #0x01	; 1
	.db #0x02	; 2
