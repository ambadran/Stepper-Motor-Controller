...
_uartGetCharacter_result_65536_69:
	.ds 1
___i2c_configurePins_pinSwitch_65536_148:
	.ds 1
___i2c_configurePins_pinConfig_262145_153:
	.ds 13
_i2cInitialiseMaster_PARM_2:
	.ds 4
_i2cInitialiseMaster_pinSwitch_65536_154:
	.ds 1
_i2cInitialiseMaster_msSpeed_65537_156:
	.ds 1
_i2cSendAck_value_65536_161:
	.ds 1
_i2cSendData_byte_65536_165:
	.ds 1
_i2cStartCommand_PARM_2:
	.ds 1
_i2cStartCommand_slaveAddress_65536_171:
	.ds 1
_i2cSendByte_byte_65536_174:
	.ds 1
_i2cReadByteSendAck_value_65536_177:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function '__i2c_configurePins'
;------------------------------------------------------------
;pinSwitch                 Allocated with name '___i2c_configurePins_pinSwitch_65536_148'
;i                         Allocated with name '___i2c_configurePins_i_131072_150'
;pinConfig                 Allocated with name '___i2c_configurePins_pinConfig_262145_153'
;pinDefinition             Allocated with name '___i2c_configurePins_pinDefinition_262145_153'
;------------------------------------------------------------
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:82: static void __i2c_configurePins(uint8_t pinSwitch) {
;	-----------------------------------------
;	 function __i2c_configurePins
;	-----------------------------------------
___i2c_configurePins:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	ar0 = 0x00
	mov	a,dpl
	mov	dptr,#___i2c_configurePins_pinSwitch_65536_148
	movx	@dptr,a
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:83: for (uint8_t i = 0; i < (sizeof(__pinConfigurations) / I2C_ROW_SIZE); i++) {
	mov	r7,#0x00
00105$:
	cjne	r7,#0x03,00121$
00121$:
	...
	ret
00122$:
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:84: if (__pinConfigurations[i][I2C_PIN_SWITCH] == pinSwitch) {
	mov	a,r7
	mov	b,#0x03
	mul	ab
	mov	r5,a
...
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:86: GpioConfig pinConfig = GPIO_PIN_CONFIG(GPIO_PORT3, GPIO_PIN0, GPIO_OPEN_DRAIN_MODE);
	mov	dptr,#___i2c_configurePins_pinConfig_262145_153
	mov	a,#0x03
	movx	@dptr,a
	mov	dptr,#(___i2c_configurePins_pinConfig_262145_153 + 0x0001)
	clr	a
	movx	@dptr,a
	mov	dptr,#(___i2c_configurePins_pinConfig_262145_153 + 0x0002)
	inc	a
	movx	@dptr,a
	mov	dptr,#(___i2c_configurePins_pinConfig_262145_153 + 0x0003)
	mov	a,#0x03
	movx	@dptr,a
	mov	dptr,#(___i2c_configurePins_pinConfig_262145_153 + 0x0004)
	clr	a
	movx	@dptr,a
	mov	dptr,#(___i2c_configurePins_pinConfig_262145_153 + 0x0005)
	movx	@dptr,a
	mov	dptr,#(___i2c_configurePins_pinConfig_262145_153 + 0x0006)
	mov	a,#0x03
	movx	@dptr,a
	mov	dptr,#(___i2c_configurePins_pinConfig_262145_153 + 0x0007)
	mov	a,#0x01
	movx	@dptr,a
	mov	dptr,#(___i2c_configurePins_pinConfig_262145_153 + 0x0008)
	clr	a
	movx	@dptr,a
	mov	dptr,#(___i2c_configurePins_pinConfig_262145_153 + 0x0009)
	movx	@dptr,a
	mov	dptr,#(___i2c_configurePins_pinConfig_262145_153 + 0x000a)
	movx	@dptr,a
	mov	dptr,#(___i2c_configurePins_pinConfig_262145_153 + 0x000b)
	movx	@dptr,a
	mov	dptr,#(___i2c_configurePins_pinConfig_262145_153 + 0x000c)
	movx	@dptr,a
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:89: pinDefinition = __pinConfigurations[i][I2C_SDA_PIN];
	mov	a,r5
	add	a,#___pinConfigurations
	mov	r5,a
	mov	a,r6
...
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:92: gpioConfigure(&pinConfig);
	...
	pop	ar5
	pop	ar6
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:94: pinDefinition = __pinConfigurations[i][I2C_SCL_PIN];
	mov	dpl,r5
	mov	dph,r6
	inc	dptr
	clr	a
...
;pinSwitch                 Allocated with name '_i2cInitialiseMaster_pinSwitch_65536_154'
;msSpeed                   Allocated with name '_i2cInitialiseMaster_msSpeed_65537_156'
;------------------------------------------------------------
...
_i2cInitialiseMaster:
	mov	a,dpl
	mov	dptr,#_i2cInitialiseMaster_pinSwitch_65536_154
	movx	@dptr,a
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:187: __i2c_configurePins(pinSwitch);
	movx	a,@dptr
	mov	dpl,a
	lcall	___i2c_configurePins
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:189: uint8_t msSpeed = MCU_FREQ / i2cFreq / 4 - 2;
	...
	dec	r4
	dec	r4
	mov	dptr,#_i2cInitialiseMaster_msSpeed_65537_156
	mov	a,r4
	movx	@dptr,a
...
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:201: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function '__waitForCompletion'
;------------------------------------------------------------
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:203: static void __waitForCompletion() {
;	-----------------------------------------
;	 function __waitForCompletion
;	-----------------------------------------
___waitForCompletion:
...
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:210: I2CMSCR = I2C_start;
	...
	mov	a,#0x01
	movx	@dptr,a
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:211: __waitForCompletion();
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:212: }
	ljmp	___waitForCompletion
;------------------------------------------------------------
...
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:215: I2CMSCR = I2C_stop;
	...
	mov	a,#0x06
	movx	@dptr,a
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:216: __waitForCompletion();
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:217: }
	ljmp	___waitForCompletion
;------------------------------------------------------------
;Allocation info for local variables in function 'i2cSendAck'
;------------------------------------------------------------
;value                     Allocated with name '_i2cSendAck_value_65536_161'
;------------------------------------------------------------
...
_i2cSendAck:
	mov	a,dpl
	mov	dptr,#_i2cSendAck_value_65536_161
	movx	@dptr,a
...
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:226: I2CMSCR = I2C_sendAck;
	...
	mov	a,#0x05
	movx	@dptr,a
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:227: __waitForCompletion();
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:228: }
	ljmp	___waitForCompletion
;------------------------------------------------------------
;Allocation info for local variables in function 'i2cSendData'
;------------------------------------------------------------
;byte                      Allocated with name '_i2cSendData_byte_65536_165'
;------------------------------------------------------------
...
_i2cSendData:
	mov	a,dpl
	mov	dptr,#_i2cSendData_byte_65536_165
	movx	@dptr,a
...
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:232: I2CMSCR = I2C_sendData;
	...
	mov	a,#0x02
	movx	@dptr,a
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:233: __waitForCompletion();
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:234: }
	ljmp	___waitForCompletion
;------------------------------------------------------------
;Allocation info for local variables in function 'i2cReceiveAck'
;------------------------------------------------------------
;result                    Allocated with name '_i2cReceiveAck_result_65537_168'
;------------------------------------------------------------
...
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:237: I2CMSCR = I2C_receiveAck;
	...
	mov	a,#0x03
	movx	@dptr,a
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:238: __waitForCompletion();
	lcall	___waitForCompletion
...
;------------------------------------------------------------
;result                    Allocated with name '_i2cReceiveData_result_65537_170'
;------------------------------------------------------------
...
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:245: I2CMSCR = I2C_receiveData;
	...
	mov	a,#0x04
	movx	@dptr,a
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:246: __waitForCompletion();
	lcall	___waitForCompletion
...
;slaveAddress              Allocated with name '_i2cStartCommand_slaveAddress_65536_171'
;result                    Allocated with name '_i2cStartCommand_result_65537_173'
;------------------------------------------------------------
...
_i2cStartCommand:
	mov	a,dpl
	mov	dptr,#_i2cStartCommand_slaveAddress_65536_171
	movx	@dptr,a
...
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:254: I2CMSCR = I2C_start_sendData_receiveAck;
	...
	mov	a,#0x09
	movx	@dptr,a
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:255: __waitForCompletion();
	lcall	___waitForCompletion
...
;------------------------------------------------------------
;byte                      Allocated with name '_i2cSendByte_byte_65536_174'
;result                    Allocated with name '_i2cSendByte_result_65537_176'
;------------------------------------------------------------
...
_i2cSendByte:
	mov	a,dpl
	mov	dptr,#_i2cSendByte_byte_65536_174
	movx	@dptr,a
...
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:263: I2CMSCR = I2C_sendData_receiveAck;
	...
	mov	a,#0x0a
	movx	@dptr,a
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:264: __waitForCompletion();
	lcall	___waitForCompletion
...
;------------------------------------------------------------
;value                     Allocated with name '_i2cReadByteSendAck_value_65536_177'
;result                    Allocated with name '_i2cReadByteSendAck_result_65537_179'
;------------------------------------------------------------
...
_i2cReadByteSendAck:
	mov	a,dpl
	mov	dptr,#_i2cReadByteSendAck_value_65536_177
	movx	@dptr,a
...
00104$:
	...
	mov	a,r6
	movx	@dptr,a
;	/home/mr-a-717/.stc/uni-stc/hal/i2c-hal.c:272: __waitForCompletion();
	lcall	___waitForCompletion
