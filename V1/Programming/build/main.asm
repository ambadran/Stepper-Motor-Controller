...
;	main.c:16: global_timer_init();
	lcall	_global_timer_init
;	main.c:17: buttons_init();
	lcall	_buttons_init
;	main.c:18: switch_init();
	lcall	_switch_init
;	main.c:19: encoder_init();
	lcall	_encoder_init
;	main.c:20: stepper_motor_init();
	lcall	_stepper_motor_init
;	main.c:21: SSD1306_Init();
	lcall	_SSD1306_Init
;	main.c:23: display_welcome_page();
	lcall	_display_welcome_page
;	main.c:25: EA = 1; // enable interrupts
;	assignBit
	setb	_EA
;	main.c:26: delay1ms(500);
	mov	dptr,#0x01f4
	lcall	_delay1ms
;	main.c:29: while(1) {
00102$:
;	main.c:30: encoder_process();  // getting latest encoder readings
	lcall	_encoder_process
;	main.c:31: buttons_process();  // getting latest button readings
	lcall	_buttons_process
;	main.c:34: application_process_current_page();
	lcall	_application_process_current_page
;	main.c:35: printf("Stepper State: %d \r", get_stepper_state());
