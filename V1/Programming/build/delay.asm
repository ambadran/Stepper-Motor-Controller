...
_uartGetCharacter_result_65536_69:
	.ds 1
_delay1ms_ms_65536_148:
	.ds 2
_delay10us_us_65536_154:
	.ds 1
_delay1us_us_65536_160:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;ms                        Allocated with name '_delay1ms_ms_65536_148'
;i                         Allocated with name '_delay1ms_i_131072_150'
;n                         Allocated with name '_delay1ms_n_262144_152'
;------------------------------------------------------------
...
_delay1ms:
	...
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_delay1ms_ms_65536_148
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;------------------------------------------------------------
;us                        Allocated with name '_delay10us_us_65536_154'
;i                         Allocated with name '_delay10us_i_131072_156'
;n                         Allocated with name '_delay10us_n_262144_158'
;------------------------------------------------------------
...
_delay10us:
	mov	a,dpl
	mov	dptr,#_delay10us_us_65536_154
	movx	@dptr,a
...
;------------------------------------------------------------
;us                        Allocated with name '_delay1us_us_65536_160'
;i                         Allocated with name '_delay1us_i_131072_162'
;n                         Allocated with name '_delay1us_n_262144_164'
;------------------------------------------------------------
...
_delay1us:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_delay1us_us_65536_160
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
